...
export function Analytics() {
  ...
  const fetchAnalytics = async () => {
    try {
      ...
      setAnalytics({
        ...
        consultancyBookings: data.consultancyBookings || [],
  ...
  const exportToCSV = (data: any[], filename: string) => {
    ...
    toast({ title: 'Success', description: `${filename}.csv downloaded successfully` });
  };
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold mt-1">{analytics.topSkills.length}</p>
              </div>
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <Button variant="outline" size="sm" onClick={() => exportToCSV(analytics.usersByRole, 'users-by-role')}>
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <Button variant="outline" size="sm" onClick={() => exportToCSV(analytics.projectsByStatus, 'projects-by-status')}>
                  <Download className="w-4 h-4 mr-2" />Export CSV
                </Button>
              </div>
            </CardHeader>
            <CardContent>
              {analytics.projectsByStatus.length === 0 ? (
                <p className="text-center text-muted-foreground py-8">No project data available yet.</p>
              ) : (
                <ResponsiveContainer width="100%" height={400}>
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <Button variant="outline" size="sm" onClick={() => exportToCSV(analytics.topSkills, 'top-skills')}>
                  <Download className="w-4 h-4 mr-2" />Export CSV
                </Button>
              </div>
            </CardHeader>
            <CardContent>
              {analytics.topSkills.length === 0 ? (
                <p className="text-center text-muted-foreground py-8">No skills data available yet. Skills are pulled from project requirements.</p>
              ) : (
                <ResponsiveContainer width="100%" height={400}>
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <Button variant="outline" size="sm" onClick={() => exportToCSV(analytics.userGrowth, 'user-growth')}>
                  <Download className="w-4 h-4 mr-2" />Export CSV
                </Button>
              </div>
            </CardHeader>
            <CardContent>
              {analytics.userGrowth.length === 0 ? (
                <p className="text-center text-muted-foreground py-8">No growth data available yet.</p>
              ) : (
                <ResponsiveContainer width="100%" height={400}>
